defmodule CryptoTradingSimulatorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CryptoTradingSimulatorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CryptoTradingSimulatorWeb.Gettext, "errors", msg, opts)
    end
  end
